...
public class ShrubsnapperFangEntity extends Entity implements TraceableEntity {
	//WEEEEEEEH the damage method I wanted to override is private
	//and because of the super.tick() well damn, so copied the whole EvokerFangs
	...
	public ShrubsnapperFangEntity(EntityType<? extends ShrubsnapperFangEntity> type, Level level) {
		super(type, level);
	}

	public ShrubsnapperFangEntity(Level p_36926_, double p_36927_, double p_36928_, double p_36929_, float p_36930_, int p_36931_, LivingEntity p_36932_) {
		this(BPASEntities.shrubsnapperFang.get(), p_36926_);
