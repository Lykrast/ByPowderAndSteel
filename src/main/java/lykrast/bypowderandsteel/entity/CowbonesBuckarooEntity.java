...
public class CowbonesBuckarooEntity extends AbstractSkeleton implements GunMob {
	public CowbonesBuckarooEntity(EntityType<? extends CowbonesBuckarooEntity> type, Level world) {
		super(type, world);
	}
	...
	protected void registerGoals() {
		...
		goalSelector.addGoal(4, new GunGoal<>(this, 1, 4, -1, 3));
	...
	protected boolean isSunBurnTick() {
		//to get them immune to sunburn (that's what the sombrero is for)
		return false;
	}
	...
	protected void populateDefaultEquipmentSlots(RandomSource random, DifficultyInstance difficulty) {
		...
		setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(BPASItems.desertShotgun.get()));
	}
	...
	protected ResourceLocation getDefaultLootTable() {
		return ByPowderAndSteel.rl("entities/cowbones_buckaroo");
	}
