...
public class ZombieSealEntity extends Monster implements GunMob {
	...
	public static AttributeSupplier.Builder createAttributes() {
		return BPASUtils.baseGunMobAttributes().add(Attributes.MAX_HEALTH, 20).add(Attributes.ARMOR, 4).add(Attributes.MOVEMENT_SPEED, 0.19).add(GWRAttributes.dmgBase.get(), -2)
