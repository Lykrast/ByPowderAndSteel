...
public class GravityExplosiveBulletItem extends GravityBulletItem {
	//I copied the GWR explosive bullet class because I did not leave an easy way to modify the variants I want
	//oopsies, but I forgive myself

	public GravityExplosiveBulletItem(Properties properties, int damage) {
	...
	//90% max splash damage instead of 75%
	private static final float DMG_MIN = 0.25f, DMG_MAX = 0.9f;
