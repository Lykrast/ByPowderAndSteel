...
public class ZombunnySlasherRenderer extends HumanoidMobRenderer<ZombunnySlasherEntity, ZombunnySlasherModel> {
	...
	public ZombunnySlasherRenderer(EntityRendererProvider.Context context) {
		super(context, new ZombunnySlasherModel(context.bakeLayer(MODEL)), 0.5f);
